<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute top-0 left-1/4 w-96 h-96 bg-red-100 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob"></div>
      <div class="absolute top-0 right-1/4 w-96 h-96 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
      <div class="absolute bottom-0 left-1/3 w-96 h-96 bg-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
    </div>
      ...
      <div class="mb-8">
        <div class="flex items-center space-x-4 mb-2">
          ...
          <div>
            ...
            <p class="text-gray-500 mt-1">管理您的个人信息和系统数据</p>
          </div>
        </div>
      </div>
          ...
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 mb-6">
            <div class="text-center">
              <div class="relative inline-block mb-4">
                <div class="w-20 h-20 rounded-full overflow-hidden bg-gradient-to-br from-red-100 to-pink-200 border-4 border-white shadow-lg ring-1 ring-black/5">
                  <img
                  ...
                  />
                  <div v-else class="w-full h-full flex items-center justify-center text-red-500">
                    <ShieldCheckIcon class="w-8 h-8" />
                  </div>
                </div>
                <div class="absolute -bottom-1 -right-1 w-6 h-6 bg-red-500 rounded-full border-2 border-white shadow-sm flex items-center justify-center">
<!--                  <CrownIcon class="w-3 h-3 text-white" />-->
              ...
              <div class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-red-100 to-pink-100 text-red-800 border border-red-200">
        ...
        <div class="lg:col-span-3">
            ...
            <form @submit.prevent="updateProfile" class="space-y-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                  ...
                  <input
                    ...
                    type="text"
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200"
                    required
                  >
                </div>
                <div class="space-y-2">
              ...
              <div class="space-y-2">
                ...
                <textarea
                  ...
                  rows="4"
                  class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 resize-none"
                  placeholder="介绍一下自己..."
                ></textarea>
              </div>
          ...
          <!-- 文章管理 -->
          <div v-if="currentTab === 'posts'" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <div class="flex items-center justify-between mb-8">
              <div class="flex items-center space-x-3">
                ...
                <div>
                  <h3 class="text-2xl font-bold text-gray-900">文章管理</h3>
                  <p class="text-gray-500">管理所有博客文章</p>
                </div>
              </div>
              <router-link
                to="/create"
            ...
            <div class="space-y-4">
              <div v-if="posts.length === 0" class="text-center py-12">
                ...
                <h4 class="text-xl font-semibold text-gray-600 mb-2">暂无文章</h4>
                <p class="text-gray-500">开始创建您的第一篇文章吧！</p>
              </div>
          ...
          <div v-if="currentTab === 'comments'" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <div class="flex items-center space-x-3 mb-8">
              ...
              <div>
                <h3 class="text-2xl font-bold text-gray-900">评论管理</h3>
                <p class="text-gray-500">管理所有用户评论</p>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div v-if="comments.length === 0" class="text-center py-12">
                ...
                <p class="text-gray-500">还没有用户发表评论</p>
              </div>
          ...
          <!-- 用户管理 -->
          <div v-if="currentTab === 'users'" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <div class="flex items-center space-x-3 mb-8">
              ...
              <div>
                ...
                <p class="text-gray-500">管理所有注册用户</p>
              </div>
            </div>
            ...
            <div class="space-y-4">
              <div v-if="users.length === 0" class="text-center py-12">
                ...
                <h4 class="text-xl font-semibold text-gray-600 mb-2">暂无用户</h4>
                <p class="text-gray-500">还没有用户注册</p>
              </div>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 border-2 border-white shadow-sm">
                      <img
                        v-if="user.avatar"
                        :src="user.avatar"
                        :alt="user.username"
          ...
          <!-- 数据统计 -->
          <div v-if="currentTab === 'stats'" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
            <div class="flex items-center space-x-3 mb-8">
              ...
              <div>
                <h3 class="text-2xl font-bold text-gray-900">数据统计</h3>
                <p class="text-gray-500">查看系统运行数据</p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                <div class="flex items-center justify-between">
                  <div>
                    <p class="text-sm font-medium text-blue-600 mb-1">文章总数</p>
                    <p class="text-3xl font-bold text-blue-900">{{ stats.totalPosts }}</p>
                  </div>
              ...
              <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                <div class="flex items-center justify-between">
                  <div>
                    <p class="text-sm font-medium text-green-600 mb-1">用户总数</p>
              ...
              <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
                <div class="flex items-center justify-between">
                  <div>
                    <p class="text-sm font-medium text-purple-600 mb-1">评论总数</p>
                    <p class="text-3xl font-bold text-purple-900">{{ stats.totalComments }}</p>
                  </div>
    ...
    <transition name="modal" appear>
      <div v-if="showPasswordModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
          <div class="p-6">
            <div class="flex items-center justify-center w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-orange-500 to-red-600 rounded-full">
              <KeyIcon class="w-6 h-6 text-white" />
            </div>

            <h3 class="text-xl font-semibold text-gray-900 text-center mb-6">修改密码</h3>
            ...
            <form @submit.prevent="updatePassword" class="space-y-4">
              ...
              <div class="flex flex-col gap-3 mt-6">
                ...
                <button
                  ...
                  :disabled="loading"
                  class="w-full py-3 px-4 bg-gray-100 text-gray-700 font-medium rounded-xl hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50"
                >
                  取消
                </button>
              </div>
